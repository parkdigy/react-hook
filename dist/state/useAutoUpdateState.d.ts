...
export declare function useAutoUpdateState<T, TState, Result = [TState, (value: SetStateAction<TState>, skipCallback?: boolean) => TState]>(state: T, callback: (state: T) => TState): Result;
