...
export declare function useAutoUpdateRefState<T, TState, Callback extends (state: T) => TState, Result = [RefObject<TState>, TState, (value: SetStateAction<TState>, skipCallback?: boolean) => TState]>(state: T, callback: Callback): Result;
